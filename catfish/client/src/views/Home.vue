  ...
  <el-container>
    ...
    <el-main>
      <div class="container-center">
        <h2>Welcome to Catfish project!</h2>
        <div>Please use your email to login</div>
        ...
        <el-form ref="form" :model="form" @submit.native.prevent="capture">
          ...
          <el-form-item>
            <el-button type="primary" @click="capture">Create my Catfish account</el-button>
          </el-form-item>
        </el-form>

        <div>
          <span>Already have an Catfish account?</span>
